...
export class GiteaRepository extends Repository {
  ...
  static attributes = {
    ...
    size_attribute,
    language_attribute,
    allow_manual_merge: boolean_attribute_writable_false,
    allow_merge_commits: boolean_attribute_writable_false,
    allow_rebase: boolean_attribute_writable_false,
    allow_rebase_explicit: boolean_attribute_writable_false,
    allow_squash_merge: boolean_attribute_writable_false,
    autodetect_manual_merge: boolean_attribute_writable_false,
    ignore_whitespace_conflicts: boolean_attribute_writable_false,
    default_delete_branch_after_merge: boolean_attribute_writable_false,
